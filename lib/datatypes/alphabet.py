...
from sequences.sequence_tool import SequenceTool
...
class Alphabet:
    ...
    It internally wraps a SequenceTool and exposes domain-specific 
    semantics like substitution_map, while keeping the sequence manipulation 
    generic and reusable.
    """
    name: str
    sequence: SequenceTool[str]
    ...
    def from_unicode_ranges(cls, name: str, ranges: List[tuple[int, int]], extras: List[int] = []):
        ...
        seq = SequenceTool(chars, strict=True)
